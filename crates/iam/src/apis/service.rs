...
use super::{
    ApiError, ApiPayload, ApiRecord, ApiRoleMatrixItem, ApiRoleQuery, ApiRoleSelection,
    DeleteApisByIdsRequest, SearchApiRequest, SetApiRolesRequest,
};
...
impl ApiService {
    ...
    pub async fn list(&self, query: SearchApiRequest) -> Result<(Vec<ApiRecord>, i64), ApiError> {
        get_api_list(&self.pool, query).await
    }
    pub async fn create(&self, payload: ApiPayload) -> Result<(), ApiError> {
        create_api(&self.pool, payload).await
    }
    pub async fn update(&self, payload: ApiPayload) -> Result<(), ApiError> {
        update_api(&self.pool, payload).await
    }
    pub async fn delete(&self, id: i64) -> Result<(), ApiError> {
        delete_api(&self.pool, id).await
    }
    pub async fn delete_many(&self, payload: DeleteApisByIdsRequest) -> Result<(), ApiError> {
        delete_apis_by_ids(&self.pool, payload).await
    }
    pub async fn find(&self, id: i64) -> Result<ApiRecord, ApiError> {
        get_api_by_id(&self.pool, id).await
    }
    pub async fn all(&self) -> Result<Vec<ApiRecord>, ApiError> {
        get_all_apis(&self.pool).await
    }
    pub async fn groups(&self) -> Result<(Vec<String>, BTreeMap<String, String>), ApiError> {
        get_api_groups(&self.pool).await
    }
    pub async fn roles(&self, query: ApiRoleQuery) -> Result<ApiRoleSelection, ApiError> {
        get_api_roles(&self.pool, query).await
    }
    pub async fn by_authority(&self, authority_id: i64) -> Result<Vec<ApiRecord>, ApiError> {
        get_apis_by_authority_id(&self.pool, authority_id).await
    }
    pub async fn role_matrix(&self) -> Result<Vec<ApiRoleMatrixItem>, ApiError> {
        get_api_role_matrix(&self.pool).await
    }
    pub async fn set_roles(&self, payload: SetApiRolesRequest) -> Result<(), ApiError> {
        set_api_roles(&self.pool, payload).await
    }
}
...
pub(crate) async fn create_api(pool: &sqlx::PgPool, payload: ApiPayload) -> Result<(), ApiError> {
...
pub(crate) async fn update_api(pool: &sqlx::PgPool, payload: ApiPayload) -> Result<(), ApiError> {
    sqlx::query(
        r#"
        update sys_apis
...
pub(crate) async fn delete_api(pool: &sqlx::PgPool, api_id: i64) -> Result<(), ApiError> {
...
pub(crate) async fn delete_apis_by_ids(
    pool: &sqlx::PgPool,
...
pub(crate) async fn get_api_by_id(pool: &sqlx::PgPool, api_id: i64) -> Result<ApiRecord, ApiError> {
...
pub(crate) async fn get_all_apis(pool: &sqlx::PgPool) -> Result<Vec<ApiRecord>, ApiError> {
...
pub(crate) async fn get_api_groups(
    pool: &sqlx::PgPool,
...
pub(crate) async fn get_api_roles(
    pool: &sqlx::PgPool,
    query: ApiRoleQuery,
...
pub(crate) async fn get_apis_by_authority_id(
    pool: &sqlx::PgPool,
    authority_id: i64,
...
pub(crate) async fn get_api_role_matrix(
    pool: &sqlx::PgPool,
) -> Result<Vec<ApiRoleMatrixItem>, ApiError> {
...
pub(crate) async fn set_api_roles(
    pool: &sqlx::PgPool,
