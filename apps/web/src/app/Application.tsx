...
function LoginRoute() {
  ...
  if (isAuthenticated(auth) && location.pathname === '/login') return <Navigate replace to={homePath(auth.userInfo?.homeRoute, menu)} />
  return <LoginPage />
}
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoutes />}>
        <Route element={<AuthorizedRoute name="dashboard" />}><Route path="/dashboard" element={<DashboardPage />} /></Route>
        <Route path="/profile" element={<ProfilePage />} />
        <Route element={<AuthorizedRoute name="users" />}><Route path="/users" element={<UsersPage />} /></Route>
        <Route element={<AuthorizedRoute name="roles" />}><Route path="/roles" element={<RolesPage />} /></Route>
        <Route element={<AuthorizedRoute name="menus" />}><Route path="/menus" element={<MenusPage />} /></Route>
        <Route element={<AuthorizedRoute name="departments" />}><Route path="/departments" element={<DepartmentsPage />} /></Route>
        <Route element={<AuthorizedRoute name="params" />}><Route path="/params" element={<ParamsPage />} /></Route>
        <Route element={<AuthorizedRoute name="dictionaries" />}><Route path="/dictionaries" element={<DictionariesPage />} /></Route>
        <Route element={<AuthorizedRoute name="files" />}><Route path="/files" element={<FilesPage />} /></Route>
        <Route element={<AuthorizedRoute name="audit-events" />}><Route path="/audit-events" element={<AuditPage />} /></Route>
