...
describe('Users workflow', () => {
  ...
  it('creates a user from the user list', async () => {
    ...
    http.defaults.adapter = (async (config) => {
      ...
      else if (config.url === '/menus/current') data = { code: 'OK', message: 'ok', data: { menus: [{ name: 'users', path: 'users' }], permissions: [] } }
    ...
    expect(createdPayload).toMatchObject({ username: 'new-operator', nickName: 'New Operator', password: 'safe-password', roleIds: [2], enable: 0 })
